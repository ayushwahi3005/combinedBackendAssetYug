...
//    		      UserDetails userDetails = this.userDetailsService.loadUserByUsername(customer.get());
				...
				System.out.println(userEmail+" "+SecurityContextHolder.getContext().getAuthentication());
//				if(userEmail != null && SecurityContextHolder.getContext().getAuthentication() != null){
//					String deviceId = jwtService.extractClaim(jwt,myclaims -> myclaims.get("deviceId", String.class));
...
//					System.out.println(deviceId+" "+currentDeviceId);
					...
					Optional<ActiveSession> activeSessionOptional=activeSessionRepository.findByUserId(userEmail);
