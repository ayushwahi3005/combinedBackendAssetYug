...
public class PaymentService {
  ...
  public String createPaymentIntent(Long amount, String currency,String name,String email) throws StripeException {
...
//                    .build()
//            )
//            .setPaymentBehavior(SubscriptionCreateParams.PaymentBehavior.DEFAULT_INCOMPLETE) // ✅ Change this
...
//
//      com.quantumai.customer.entity.Subscription subscription1=new com.quantumai.customer.entity.Subscription();
//      if(isStillValid){
...
//      if(planSelected==SubscriptionPlan.MONTHLY) subscription1.setExpiryDate(LocalDate.now().plusMonths(1));
...
//                                  .build()
//                          )
//                          .setProrationBehavior(SubscriptionUpdateParams.ProrationBehavior.CREATE_PRORATIONS) // Optional: Handle proration
//                          .build();
//
...
//              .setBillingCycleAnchor(expiryDate.atStartOfDay(ZoneId.systemDefault()).toEpochSecond()) // ✅ Start from expiry date
  ...
  public void saveCard(String paymentMethodId, String customerEmail, String cardholderName, String companyId) throws StripeException {
    ...
    Customer customer = stripeService.findCustomerByEmail(customerEmail); // ✅ Check for existing customer
...
//       customerStripeDetailsRepository.save(customerStripeDetails);
  ...
  private Invoice createInvoice(String customerId, Long amount, String currency, String description) throws StripeException {
